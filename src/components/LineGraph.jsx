...
export default function AreaChartFillByValue() {
  ...
  const data = [
    ...
    4500, 3500, 2500, 3000, 3300,
    4200, 3100, 2000, 1500, 5000
  ];

  return (
    <Stack direction="column" width="100%" spacing={1} sx={{ backgroundColor: 'white', minHeight: "348px", borderRadius: "10px",gridColumn:"span 2" }}>
      <div className="graph_text">Total Earnings</div>
      <div className='line_under'></div>
      <LineChart
        xAxis={[{ data: xData, scaleType: 'point' }]}
        ...
        series={[{ data, showMark: false, area: true }]}
        height={200}
        margin={{ top: 10, bottom: 30, left: 75 }}
        sx={{
          // padding: "1rem",
          [`& .${areaElementClasses.root}`]: {
            fill: 'url(#swich-color-id-2)',
